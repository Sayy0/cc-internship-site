...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($checkEmailResult->num_rows > 0){
        ...
        if ($conn->query($insertQuery) === TRUE) {
            ...
            $createInternQuery = "INSERT INTO Internship (studentId, indemnityStatus, parentsAckStatus, acceptanceLtrStatus, report1Status, report2Status, report3Status, finalReportStatus) VALUES ('$studentId', 'empty', 'empty', 'empty', 'empty', 'empty', 'empty')";
